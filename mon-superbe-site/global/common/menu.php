<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <?php for($i=1;$i <= 7;$i++) : ?>
                <a class="dropdown-item" href="../../3-tableaux/exo<?=$i?>/index.php">exo<?=$i?></a>
            <?php endfor; ?>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                 <?php for($i=1;$i <= 8; $i++) : ?>
                <a class="dropdown-item" href="../../4-boucles/exo<?=$i?>/index.php">exo<?=$i?></a>
            <?php endfor; ?>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                 <?php for($i=1;$i <= 6; $i++) : ?>
                <a class="dropdown-item" href="../../7-string/exo<?=$i?>/index.php">exo<?=$i?></a>
            <?php endfor; ?>
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                 <?php for($i=1;$i <= 6; $i++) : ?>
                <a class="dropdown-item" href="../../8-formulaires/exo<?=$i?>/index.php">exo<?=$i?></a>
            <?php endfor; ?>
